...
public class Euler_022 extends EulerBase
{
	public Euler_022()
	{
		title	= "Names scores" ;
		...
		runsets	= new RunSet[] {
					new RunSet( "Problem",	new Run( names,	871198282	) )
				} ;
		report	= "Sum of %,d name-scores is %,d" ;
	}
...
//----------------------------------------------------------------------------------
	...
	private static long name_score( String name, int posn )
	{
		int sum = 0 ;
